...
if VISUALIZE_METRIC_ACCURACY:
    for csv in glob.glob("validation/results_acc_gwa/best_models/*.csv"):
        view_results_metric_accuracy_mesh2ir_vs_rirbox(results_csv=csv)
    for csv in glob.glob("validation/results_acc_hl2/best_models/*.csv"):
        view_results_metric_accuracy_mesh2ir_vs_rirbox(results_csv=csv)
