...
if not os.path.exists(args.preproc_obj_path): os.mkdir(args.preproc_obj_path)
...
for json_file_name in tqdm(files):
    ...
    # simplify obj
    simple_file_path = obj_preprocessing(temp_file_path, args.preproc_obj_path, args.target_faces)
