...
from dataset_generation_scripts.config_and_csv_utility import get_empty_csv_row
from dataset_generation_scripts.generate_one_SBAM_datapoint import generate_one_SBAM_datapoint

'''
Use this script to generate dataset data points.

Usage in root RIRbox folder: python -m datasets.ShoeboxMeshDataset.generate_SBAM_dataset
...
parser.add_argument('--datasetname', type=str, default="subsets/sbox_mesh.csv", help='Dataset csv name')
parser.add_argument('--config', type=str, default="generation_configs/default.json", help='Path to configuration file.')
